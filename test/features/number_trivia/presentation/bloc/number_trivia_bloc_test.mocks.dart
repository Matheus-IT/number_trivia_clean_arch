...
// in number_trivia_clean_arch/test/features/number_trivia/presentation/bloc/number_trivia_bloc_test.dart.
...
import 'package:number_trivia_clean_arch/core/converters/number_input_converter.dart'
    as _i10;
import 'package:number_trivia_clean_arch/core/error/failures.dart' as _i6;
import 'package:number_trivia_clean_arch/core/usecases/usecase.dart' as _i8;
...
class MockNumberInputConverter extends _i1.Mock
  ...
  @override
  _i3.Either<_i6.Failure, int> stringToUnsignedInteger(String? number) =>
      (super.noSuchMethod(
        Invocation.method(
